...
export const HomePage = (props) => {
  ...
  <div>
    <div>
        {isUserPopupOpen && <form className="userForm" disabled={isUserPopupOpen}>
          <input type="text" placeholder=""></input>
          <button onClick={() => setUserPopupOpen(false)}> Close </button>
        </form>}
    </div>
      <div>
        <div className="home_header">
          ...
          <div className="home_actions">
            ...
            <button disabled={activeTable === "None"}>Delete</button>
            <button disabled={activeTable === "None"}>Edit</button>
            <input disabled={activeTable === "None"} type="text" placeholder="Search"></input>
            <button disabled={activeTable === "None"}> Search</button>
